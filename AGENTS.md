...
| **08:00 UTC (= 15:00 VN)** | **Render BackgroundScheduler** | `hmip_daily_report` (PR #20) | `build_daily_report(today)` → render 7-section → `send_daily_report` (TG/Discord send_text) |
