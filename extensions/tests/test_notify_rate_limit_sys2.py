...
def test_sys2_message_includes_unit_box_bottle():
    ...
    from extensions.notifiers import discord, telegram
    ...
    # Giá tham chiếu (lon) đã bị xoá khỏi message theo yêu cầu.
    assert "tham chiếu" not in msg
